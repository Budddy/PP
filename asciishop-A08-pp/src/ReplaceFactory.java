...
/**
 * This Class provides a method to create a new ReplaceOperation. It implements the Factory interface.
 * 
 * @version 7
 * @author EProg
 * 
...
public class ReplaceFactory implements Factory {
	...
	/**
	 * This method reads the two required parameter for a ReplaceOperation and creates a new ReplaceOperation.
	 * 
	 * @param scanner
